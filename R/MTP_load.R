...
closeDr=function(remDr){
	...
	{
		tryCatch({c=remDr$quit()},error=function(e) e)
		l=length(c)
...
generate_tps=function(
	...
	# obtained with systran_check
	systran_sl=c('sq','sq','sq','sq','ar','ar','ar','ar','bn','bg','bg','bg','bg','my','ca','ca','ca','ca','zh-CN','zh-CN','zh-CN','zh-CN','zh-CN','zh-TW','zh-TW','zh-TW','zh-TW','hr','hr','hr','hr','cs','cs','cs','cs','da','da','da','da','nl','nl','nl','nl','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','en','et','et','et','et','fi','fi','fi','fi','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','fr','de','de','de','de','de','de','de','de','de','de','de','de','de','de','de','de','de','de','de','de','de','de','de','de','de','de','de','de','de','de','de','de','de','de','de','de','de','de','de','de','de','el','el','el','el','el','iw','iw','iw','iw','hi','hi','hi','hi','hu','hu','hu','hu','id','id','id','id','it','it','it','it','it','ja','ja','ja','ja','ja','ja','ko','ko','ko','ko','ko','ko','lv','lv','lv','lv','lt','lt','lt','lt','ms','ms','ms','ms','no','no','no','no','fa','fa','fa','fa','pl','pl','pl','pl','pt','pt','pt','pt','ro','ro','ro','ro','ru','ru','ru','ru','ru','sr','sr','sk','sk','sk','sk','sl','sl','sl','sl','so','es','es','es','es','es','es','es','es','es','es','es','es','es','es','es','es','es','es','es','es','es','es','es','es','es','es','es','es','es','es','es','es','es','es','es','es','es','es','es','es','es','sv','sv','sv','sv','tl','ta','ta','th','th','th','th','th','tr','tr','tr','tr','uk','uk','uk','uk','uk','ur','ur','ur','ur','vi','vi','vi','vi')
	systran_tl=c('en','es','de','fr','fr','en','de','es','en','de','fr','en','es','en','es','de','fr','en','en','de','es','ja','fr','fr','es','de','en','en','de','es','fr','de','fr','en','es','de','en','es','fr','de','fr','es','en','sq','nl','it','pt','ar','zh-CN','lv','ro','bn','bg','th','et','vi','my','ca','fi','sr','hi','de','ur','sk','el','lt','ko','sl','zh-TW','iw','no','so','hr','uk','fa','ta','cs','hu','pl','ms','da','id','fr','sv','tr','tl','ja','es','ru','ps','de','fr','en','es','de','en','fr','es','nl','en','hi','th','zh-CN','et','uk','sq','ca','sr','bg','hr','no','lv','ar','lt','ur','de','sl','iw','ko','id','fi','pt','fa','sv','ro','sk','pl','hu','tr','da','it','ms','el','es','zh-TW','ja','cs','ru','vi','zh-CN','ar','lt','en','fr','iw','no','bg','fi','hi','fa','ko','sv','pt','pl','hr','th','ca','uk','ur','ms','tr','nl','vi','hu','ro','lv','sr','zh-TW','id','sq','ja','it','es','ru','da','el','sk','cs','sl','et','es','en','de','it','fr','de','en','fr','es','de','es','en','fr','es','de','en','fr','fr','en','de','es','es','fr','el','de','en','zh-CN','ko','de','es','en','fr','fr','ja','zh-CN','de','es','en','en','fr','de','es','fr','es','en','de','en','de','fr','es','en','de','es','fr','fr','en','es','de','es','fr','en','de','en','de','es','fr','en','de','es','fr','fr','de','es','uk','en','fr','en','en','es','fr','de','de','es','fr','en','en','ar','el','ca','bg','uk','fa','lv','iw','ro','hi','ur','no','pt','sk','vi','hu','lt','fi','sr','zh-TW','en','it','cs','hr','sv','th','nl','et','id','ru','zh-CN','sq','sl','de','ko','ja','tr','da','fr','ms','pl','fr','es','de','en','en','en','fr','es','en','zh-CN','de','fr','de','en','fr','es','en','es','de','fr','ru','en','de','es','fr','de','en','fr','es')
...
systran_translate=function(sl,tl,send,remDr){
	...
	{
		wait=round(as.numeric(difftime(Sys.time(),t0,units="sec")),0)
		tryCatch({input_area=remDr$findElements(using="css selector", "textarea.form-control")},error=function(e) e)
		l=length(input_area)
	}

	input_area[[1]]$sendKeysToElement(list(paste(send,collapse="\n"),key="enter"))
	...
	output_area=list()
	translation=list()
	while(equall==FALSE & locked==FALSE & unable==FALSE & wait<timeout)
	{
		wait=round(as.numeric(difftime(Sys.time(),t0,units="sec")),0)
		tryCatch({
				output_area=remDr$findElements(using="css selector","#translateContent")
				translation=strsplit(output_area[[1]]$getElementText()[[1]],split="\n")[[1]]
				locked=grepl("Too many requests",remDr$getPageSource()[[1]])
				unable=grepl("There is no profile",remDr$getPageSource()[[1]])
				},error=function(e) e)
		equall=length(translation)==length(send)
	}
...
generate_source_support_blocks=function(mtp_directory,project_name,input_file_name,text_identifier_field_name,tps){
	...
	if(!file.exists(blocks_file_name)|!file.exists(plan_file))
	{
		...
		for(source in unique(source_tps$source_languages))
		{
			...
			{
				source_blocks_list[[s]]=cbind.data.frame(source_language=source,source_support_engine=engine,get_blocks(engine,desc))
				s=s+1
			}
		}
...
translate_source_support_blocks=function(mtp_directory,project_name,reftime,refsleep,timeout_translations){
...
translate_support_target_blocks=function(mtp_directory,project_name,reftime,refsleep,timeout_translations){
